...
# Add paths
sys.path.insert(0, r'/home/dell/coding/bash/10x-agentic-setup/mcp_servers/ml_testing_qa/src')
sys.path.insert(0, r'/home/dell/coding/bash/10x-agentic-setup/mcp_servers/shared/src')

# Set environment
os.environ['MCP_SERVER_PORT'] = '8005'
os.environ['MCP_SERVER_HOST'] = 'localhost'

# Import and run server
try:
    import server
    print(f'✅ {server.__name__} server started on port 8005')
    ...
    print(f'Server ML Testing QA stopping...')
except Exception as e:
    print(f'Error in server ML Testing QA: {e}')
    import traceback
    traceback.print_exc()
