...
# Add paths
sys.path.insert(0, r'/home/dell/coding/bash/10x-agentic-setup/mcp_servers/agentic_workflow/src')
sys.path.insert(0, r'/home/dell/coding/bash/10x-agentic-setup/mcp_servers/shared/src')

# Set environment
os.environ['MCP_SERVER_PORT'] = '8003'
os.environ['MCP_SERVER_HOST'] = 'localhost'

# Import and run server
try:
    import server
    print(f'✅ {server.__name__} server started on port 8003')
    ...
    print(f'Server Agentic Workflow stopping...')
except Exception as e:
    print(f'Error in server Agentic Workflow: {e}')
    import traceback
    traceback.print_exc()
