...
# Add paths
sys.path.insert(0, r'/home/dell/coding/bash/10x-agentic-setup/mcp_servers/context_aware_memory/src')
...
try:
    import server
    print(f'✅ {server.__name__} server started on port 8001')
    ...
    print(f'Server Context-Aware Memory stopping...')
except Exception as e:
    print(f'Error in server Context-Aware Memory: {e}')
    import traceback
    traceback.print_exc()
