# /mcp-debug - Intelligent MCP Configuration Debugger
...
Run '/mcp-debug --diagnose all' for detailed analysis
```
...
/mcp-debug --test-tools ml-testing-qa
...
/mcp-debug --full > mcp_debug_report.md
```
